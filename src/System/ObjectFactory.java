 ...
 * generated in the System package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreatePlayerAccount_QNAME = new QName("http://Servers/", "createPlayerAccount");
    private final static QName _PlayerSignIn_QNAME = new QName("http://Servers/", "playerSignIn");
    private final static QName _PlayerSignInResponse_QNAME = new QName("http://Servers/", "playerSignInResponse");
    private final static QName _CreatePlayerAccountResponse_QNAME = new QName("http://Servers/", "createPlayerAccountResponse");
    private final static QName _SuspendAccountResponse_QNAME = new QName("http://Servers/", "suspendAccountResponse");
    private final static QName _SuspendAccount_QNAME = new QName("http://Servers/", "suspendAccount");
    private final static QName _TransferAccountResponse_QNAME = new QName("http://Servers/", "transferAccountResponse");
    private final static QName _PlayerSignOutResponse_QNAME = new QName("http://Servers/", "playerSignOutResponse");
    private final static QName _GetPlayerStatusResponse_QNAME = new QName("http://Servers/", "getPlayerStatusResponse");
    private final static QName _PlayerSignOut_QNAME = new QName("http://Servers/", "playerSignOut");
    private final static QName _TransferAccount_QNAME = new QName("http://Servers/", "transferAccount");
    private final static QName _GetPlayerStatus_QNAME = new QName("http://Servers/", "getPlayerStatus");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: System
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "createPlayerAccount")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "playerSignIn")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "playerSignInResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "createPlayerAccountResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "suspendAccountResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "suspendAccount")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "transferAccountResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "playerSignOutResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "getPlayerStatusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "playerSignOut")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "transferAccount")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Servers/", name = "getPlayerStatus")
